...
- `Reveal-Public-Action-V0.1.1-END-TIME-WINTER.md` locks the ending order: shared public reality sufficiently restored → one unique valid Beijing Standard Time → unified winter protocol becomes valid → citywide snow.
- `Pressure-Ladder-V0.1-CANONICAL.md` governs the macro escalation of opposition / pressure and requires a real-world Moment of Grace before the female chief abstracts the minimum-common-reality principle. The concrete Moment of Grace is now locked by EP08; the older `TBD` on the incident is superseded by `Pilot-EP08-Checkpoint-Security-AI-Standoff-V0.1-CANONICAL.md`.
- `Pilot-EP01-302-Building-V0.2-CANONICAL.md` is the current authoritative EP01 file: 302楼, physical existence vs system reality, local gravity-direction anomaly/reversal, orbital-city reveal, chief rescue.
- `Pilot-EP02-Islands-System-Failure-V0.1-CANONICAL.md` governs EP02: city-level unified/shared coordination fails while regional/professional AIs remain locally capable; the bridge opens before everyone clears; city progressively islands; system-recovery time vs unequal island survival windows becomes the hard pressure.
...
The following files remain revision history and do not independently override newer canon:
...
### EP01 provenance
- `Pilot-EP01-343-Building-V0.1-CANONICAL.md` — historical only; 343楼 naming and older “thrown out” mechanism are superseded by EP01 V0.2.
