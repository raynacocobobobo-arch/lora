...
- `Pilot-EP05-Wedding-Mirror-V0.2-CANONICAL.md` locks EP05 placement and social relation: the missing real groom is not the male lead's former coworker, but a member of another department/professional/action group who becomes missing during the EP02-era islanding; the wedding is an EP02 social/private echo with a commemoration/waiting atmosphere; male lead and female chief attend as witnesses/guests through the broader disaster-response context, not because the groom is secretly a close friend. It also locks the EP04→EP05 contrast and the Pilot five-episode macro order.
- `Pilot-EP05-Wedding-Mirror-V0.3-BRIDE-SNOW-PATCH.md` revises the bride and ending: the real bride is also missing; both bride and groom visible at the ceremony are AI reconstructions generated from their past data; the audience should initially assume only the groom is AI and learn near the end that the bride was also a projection; the past timeline still follows only the real groom, leaving the bride's disappearance unexplained in this episode; the ceremony is therefore a commemorative completion of an unfinished wedding, not a living-person / dead-person wedding. The ceremony may use artificial/projected snow, and after it ends a small amount of **real, local, unstable snow** appears outside. This EP05 snow is not citywide winter, does not mean shared Beijing Standard Time has been restored, and must not supersede the Finale's citywide real-winter payoff.
...
- EP04→EP05 contrast = EP04 lets the audience experience a continuous long-term AI relationship as ordinary intimate life; EP05 immediately presents generated AI reconstructions that look and act like missing humans but are not the same continuity category. Do not over-explain the distinction in dialogue.
