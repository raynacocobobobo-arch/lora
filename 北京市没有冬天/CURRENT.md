...
- 女科长 = 拉尼 × 玛奇玛 / 主情感牵引位 / physical rescue + procedural rescue + delayed identity reveal / joins critical field cases with male lead / later pushes minimum-common-reality action upward and may be absent from the field line for several days or episodes
...
- Public-action line = case-by-case authorization → female chief realizes this cannot scale → proposes minimum-common-reality reconstruction → escalates to citywide representative/authorization level → city authorizes the search/reconstruction process, not a pre-written consensus → regions reconnect one by one.
