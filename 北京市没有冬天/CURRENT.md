...
3. highest-numbered active Episode Snapshot for concrete episode facts;
...
## 03｜Highest timeline lock

> **Meteor impact occurs BEFORE EP01.**

Timeline:

> **T0 meteor impact → first-wave rescue / isolation / rerouting → EP01 → EP02 continuing damage reaches rescue limit → EP03–04 → EP05 uniquely looks back at T0 from the bride’s ordinary-person perspective.**

EP02 is NOT the impact event.

EP05 is the only episode explicitly returning to impact-day ordinary-person consequences.

---

## 04｜Active episode authority map
...
> **gentle / stable / highly controlling.**
...
- EP03: protocol handshake complete ≠ physical reality connected;
- EP06: shared reference enables trustworthy handshake / synchronization;
- EP08: physical corridor exists but public-authorization handshake fails;
- EP10: final handshake confirms/transfers state, not subject.

### Hand

- EP01: chief physically grabs male;
- EP05: reconstructed hand / ring / ceremony;
- EP10: continuous AI truly exists but cannot be physically held; protocol handshake follows.

### Snow

- EP05: artificial/projected snow + tiny real local snow;
- EP06: local winter ≠ common Beijing winter;
- EP10: one common public now → unified winter → snow.
...
- no EP05 direct route accident killing bride;
...
- **no broad architecture expansion after this gate unless screenplay exposes a real contradiction.**
