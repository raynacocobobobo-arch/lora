# 《重庆时间》ANIMATION STYLE V1 — PROMPT PACKAGE

- Updated: 2026-09-03
- Status: `ACTIVE PROMPT PACKAGE`
- Style lock: `2026-09-03-ANIMATION-STYLE-V1-LOCK.md`
- Primary visual master: `/重庆时间/visual/style-masters/SECOND_NEW_CHONGQING_ANIMATION_STYLE_MASTER_V1.png`

---

# 01｜Universal style header

Use this at the start of new environment / architecture prompts unless the user explicitly selects another lane.

```text
《重庆时间》统一动画视觉风格，Animation Style V1。
...
historical,
restrained,
monumental without visual noise.
```
...
no photobash,
no NASA realism,
no Star-Wars-like battleship aesthetic,
...
Append when the output will be used directly for Seedance image-to-video.
...
Use when reproducing or deriving from the approved station visual master.
...
空间站颜色以黑、旧白、冷灰为主，只有少量锈红 / 氧化红作为维修、结构识别和公共系统强调色。
...
# 05｜Text policy reminder

For ordinary production reference frames:
...
`第二新重庆市` is an architectural / municipal marking, not the default title of the picture.
...
+
[Animation Style V1 universal style header]
+
